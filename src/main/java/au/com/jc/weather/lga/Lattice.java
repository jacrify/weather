 ...
 * See http://new.math.uiuc.edu/im2008/dakkak/papers/files/fhp1986.pdf for
 * details.
 * This is the FHP-I variant currently.
 * Basically we have a lattice of points, which correspond to a hex grid on the
 * earth.
...
public class Lattice {
     ...
     * For each Point, calculate who the neighbour are, call flight(),
     * then scatter()
     */
    public void step() {
        //flight
     ...
     * @param x
     * @param y
     * @return an array of neighbours in order nw,ne,e,se,sw. Null means
     * edge-particles should bounce
     */
     ...
     * @param sampleSize radius of sample. 1 means just 1 point, 2 means 1 point
     *                   and it's neighbours, etc
     * @return A au.com.jc.weather.lga.PointSample object holding the sampled
     * values
     */
